    ...
    @section('content')
        <div class="container mx-auto mt-5 flex flex-col space-y-4">
            ...
            <div class="container mx-auto mt-5 flex flex-col space-y-4 items-center">
                ...
                <a href="{{ route('sites.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 w-1/3 sm:w-1/3 md:w-1/4 lg:w-1/5 text-center">Create New site</a>
            </div>
            <br>
            <br>
            <br>
